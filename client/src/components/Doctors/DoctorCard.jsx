...
const DoctorCard = ({ doctor }) => {
    ...
    return (
        <div className='p-3 lg:p-5' data-aos="flip-left">
            ...
            <h2 className='text-[18px] leading-[30px] lg:text-[20px] lg:leading-9 text-black font-semibold mt-3 lg:mt-5 '>{name}</h2>

            <div className='mt-2 lg:mt-4 flex items-center justify-between'>
                <span className='bg-[#CCF0F3] text-blue-500 py-1 px-2 lg:py-2 lg:px-4 text-[12px] leading-4 lg:text-[14px] lg:leading-7  rounded-xl'>{specialization}</span>
            ...
            <div className='mt-[18px lg:mt-5 flex items-center justify-between]'>
                <div>
                    ...
                    <p className='text-[14px] leading-6 font-normal text-black'>At {hospital}</p>
                </div>
                <Link
                    to="/doctor"
                ...
                >
                    <img src={arrow} alt="" className='hover:p-1 transition-all duration-300 ' />
                </Link>
            </div>
