    ...
    >
      <div className="flex flex-col justify-center items-start gap-10 lg:w-[60%]">
        <div className="flex flex-col justify-center items-start">
          ...
          <h1 className="lg:text-6xl font-lime md:text-4xl text-2xl font-semibold">Experience</h1>
        </div>
        <button className="px-16 ml-4 bg-black text-white py-4 lg:text-xl text-lg font-semibold rounded-[20px] italic shadow-md hover:shadow-xl transition-all duration-300 ease-in-out">
          Book now
        </button>
      </div>
    </div>
