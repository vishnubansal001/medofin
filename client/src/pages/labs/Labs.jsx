          ...
          <div className="w-full flex items-center justify-center py-12">
                 <div className="max-w-2xl flex items-center justify-center w-full flex-col gap-4">
                  <div className="flex-col items-center justify-center flex gap-3">
                    ...
                    <p className="text-center font-Inter">Wy wait on your wellbeing? Start your health journey with Medofine</p>
                  </div>
                  <div className="flex items-center justify-center gap-3 font-Inter w-full">
                    <button className="bg-[#28661E] text-white px-4 py-2 rounded-md">Schedule a Test</button>
                    <button className="bg-[#D9D9D9] text-black px-4 py-2 rounded-md">Find a Lab</button>
                  </div>
